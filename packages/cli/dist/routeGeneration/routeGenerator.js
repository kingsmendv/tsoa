...
var RouteGenerator = /** @class */ (function () {
  ...
  RouteGenerator.prototype.GenerateRoutes = function (middlewareTemplate, pathTransformer) {
    return __awaiter(this, void 0, void 0, function () {
      var fileName, content, existingContent;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            if (!this.options.noWriteIfUnchanged) return [3 /*break*/, 3];
            return [4 /*yield*/, fs_1.fsExists(fileName)];
          case 1:
            if (!_a.sent()) return [3 /*break*/, 3];
            return [4 /*yield*/, fs_1.fsReadFile(fileName)];
          case 2:
            existingContent = _a.sent().toString();
  ...
  RouteGenerator.prototype.buildContent = function (middlewareTemplate, pathTransformer) {
    ...
    return routesTemplate({
      ...
      controllers: this.metadata.controllers.map(function (controller) {
        ...
        return {
          actions: controller.methods.map(function (method) {
            ...
            var uploadFileParameter = method.parameters.find(function (parameter) {
              return parameter.type.dataType === 'file';
            });
            var uploadFilesParameter = method.parameters.find(function (parameter) {
              return parameter.type.dataType === 'array' && parameter.type.elementType.dataType === 'file';
            });
            return {
      ...
      useFileUploads: this.metadata.controllers.some(function (controller) {
        return controller.methods.some(function (method) {
          return !!method.parameters.find(function (parameter) {
