...
var MethodGenerator = /** @class */ (function () {
  ...
  MethodGenerator.prototype.Generate = function () {
    ...
    var _a = this.getMethodSuccessResponse(type),
      successResponse = _a.response,
      successStatus = _a.status;
  ...
  MethodGenerator.prototype.buildParameters = function () {
    ...
    var parameters = this.node.parameters
      ...
      .reduce(function (flattened, params) {
        return __spread(flattened, params);
      }, []);
    ...
    var hasFormDataParameters = parameters.some(function (p) {
  ...
  MethodGenerator.prototype.processMethodDecorators = function () {
    ...
    this.path = decoratorUtils_1.getPath(decorator, this.current.typeChecker);
  };
  ...
  MethodGenerator.prototype.getMethodSuccessResponse = function (type) {
    ...
    if (!decorators || !decorators.length) {
      var description_1 = jsDocUtils_1.getJSDocComment(this.node, 'returns') || 'Ok';
      return {
        response: {
          description: isVoidType_1.isVoidType(type) ? 'No content' : description_1,
  ...
  MethodGenerator.prototype.supportsPathMethod = function (method) {
    return ['options', 'get', 'post', 'put', 'patch', 'delete', 'head'].some(function (m) {
