...
exports.getPath = exports.isDecorator = exports.getSecurites = exports.getDecoratorValues = exports.getNodeFirstDecoratorValue = exports.getNodeFirstDecoratorName = exports.getDecorators = void 0;
...
function getPath(decorator, typeChecker) {
  var _a = __read(getDecoratorValues(decorator, typeChecker), 1),
    path = _a[0];
  if (path === undefined) {
    return '';
  }
