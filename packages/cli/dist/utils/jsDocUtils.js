...
exports.isExistJSDocTag = exports.getJSDocTags = exports.getJSDocTagNames = exports.getJSDocComments = exports.getJSDocComment = exports.getJSDocDescription = void 0;
...
function getJSDocComment(node, tagName) {
  var comments = getJSDocComments(node, tagName);
...
function getJSDocComments(node, tagName) {
  var tags = getJSDocTags(node, function (tag) {
    return tag.tagName.text === tagName || tag.tagName.escapedText === tagName;
  });
  if (tags.length === 0) {
    return;
  }
